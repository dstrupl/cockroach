...
object RsuReportPdfGenerator {
    ...
    fun generate(report: RsuReport, taxableMode: Boolean = false, broker: String = "Charles Schwab & Co., Morgan Stanley & Co."): ByteArray {
        ...
        val rows = report.printableRsuList.map { r ->
            val base = listOf(r.date, r.amount.toString(), r.onePriceDolarValue, r.vestDolarValue, r.exchange, r.vestCroneValue)
        ...
        return PdfReportGenerator.generate(PdfReportDefinition(
            ...
            subtitles = listOf("Program RS – bezplatné poskytnutí akcií", "Cenný papír: Cisco Systems", "Obchodník: $broker"),
